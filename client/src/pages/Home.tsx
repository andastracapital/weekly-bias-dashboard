...
// Countdown Timer Component (must be separate to use hooks correctly)
const CountdownTimer = ({ eventTime }: { eventTime: string }) => {
              ...
              <div className="flex justify-between md:justify-end gap-6">
                ...
                <div className="flex flex-col gap-1 text-right">
                  ...
                  <span className="text-sm font-bold text-gray-400 font-mono">
                    {dailyData.lastUpdate.replace('Frankfurt Time', 'FFT')}
                  </span>
                </div>
              </div>
            </div>
